...
const CONFIG = {
    winners: {
        ...
        third: {
            ...
            photo: "photos/sullyper.jpg"
        }
    },
    finalists: [
        { name: "wleite", fullName: "Wladimir Leite", country: "Brazil", countryCode: "BR", photo: "photos/wleite.jpg" },
        { name: "Daiver19", fullName: "Dmytro Kovalenko", country: "Ukraine", countryCode: "UA", photo: "photos/Daiver19.jpg" },
        { name: "sullyper", fullName: "Benjamin Butin", country: "France", countryCode: "FR", photo: "photos/sullyper.jpg" },
        { name: "gaha", fullName: "Szymon Mikler", country: "Poland", countryCode: "PL", photo: "photos/gaha.jpg" },
        { name: "xllledanx", fullName: "Erik Kvanli", country: "Sweden", countryCode: "SE", photo: "photos/xllledanx.jpg" },
        { name: "frictionless", fullName: "Jeremy Sawicki", country: "United States", countryCode: "US", photo: "photos/frictionless.jpg" },
        { name: "Acarreo", fullName: "Alvaro Carrera", country: "Spain", countryCode: "ES", photo: "photos/Acarreo.jpg" },
        { name: "eulerscheZahl", fullName: "Ralph Pulletz", country: "Germany", countryCode: "DE", photo: "photos/eulerscheZahl.jpg" },
        { name: "kovi", fullName: "Laszlo Kovacs", country: "Hungary", countryCode: "HU", photo: "photos/kovi.jpg" },
        { name: "marwar22", fullName: "Marcin Wróbel", country: "Poland", countryCode: "PL", photo: "photos/marwar22.jpg" },
        { name: "krismaz", fullName: "Krzysztof Maziarz", country: "Poland", countryCode: "PL", photo: "photos/krismaz.jpg" },
        { name: "therealbeef", fullName: "Jan Nunnink", country: "Netherlands", countryCode: "NL", photo: "photos/therealbeef.jpg" }
    ],
    provisionalScores: [
        { name: "Daiver19", score: 96.23912998921175, submissionId: "provisional" },
        { name: "wleite", score: 96.12281984913679, submissionId: "provisional" },
        { name: "xllledanx", score: 93.88868954513856, submissionId: "provisional" },
        { name: "frictionless", score: 93.88058241540857, submissionId: "provisional" },
        ...
        { name: "kovi", score: 91.89590538896853, submissionId: "provisional" },
    ...
    timing: {
        ...
        problem: 5000,
        finalists: 8000,
        leaderboardProvisional: 4000,
        leaderboardTransition: 2500,
        leaderboardFinal: 30000, // Increased to accommodate 2.5s per placement reveal (12 placements = ~30s)
        countdown: 4000,
        podium: 6000,
        cta: 5000
    }
...
function populateFinalists() {
    ...
    // Sort finalists alphabetically by name
    ...
    sortedFinalists.forEach((finalist) => {
        ...
        const imageUrl = finalist.photo || `photos/${finalist.name}.jpg`;
...
function populateLeaderboard(scores, isFinal) {
    ...
    sortedScores.forEach((entry, index) => {
        ...
        const photo = finalistInfo ? (finalistInfo.photo || `photos/${finalistInfo.name}.jpg`) : '';
...
function populateWinners() {
    ...
    if (firstAvatar) {
        const firstImageUrl = CONFIG.winners.first.photo || `photos/${CONFIG.winners.first.name}.jpg`;
    ...
    if (secondAvatar) {
        const secondImageUrl = CONFIG.winners.second.photo || `photos/${CONFIG.winners.second.name}.jpg`;
    ...
    if (thirdAvatar) {
        const thirdImageUrl = CONFIG.winners.third.photo || `photos/${CONFIG.winners.third.name}.jpg`;
