...
import { rootRoute as projectsRootRoute } from '~/apps/work/src/config/routes.config'
import { buildProjectLandingPath, useFetchProjectShowcasePost, UseFetchProjectShowcasePostResult } from '~/apps/work/src/lib'
...
interface ProjectShowcasePostPageProps {
}

const ProjectShowcasePostPage: FC<ProjectShowcasePostPageProps> = props => {
    const routeParams: Params<string> = useParams()
    const { post }: UseFetchProjectShowcasePostResult = useFetchProjectShowcasePost(routeParams.projectId, routeParams.postId);
    const industries = useMemo(() => post?.industries.map(ind => ind.name).join(', '), [post?.industries])
                        ...
                        <div className={styles.panel}>
                            ...
                            <div>
                                <a href={projectUrl} target="_blank" rel="noreferrer,noopener">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" className="icon-lg">
                                        <g clip-path="url(#clip0_56_1248)">
                                            <path d="M8.79335 5.79202C9.22657 5.99886 9.60382 6.30664 9.89342 6.68951C10.183 7.07238 10.3765 7.51916 10.4576 7.99232C10.5388 8.46548 10.5052 8.9512 10.3596 9.40867C10.2141 9.86614 9.96093 10.282 9.62135 10.6214L6.62135 13.6213C6.05874 14.184 5.29567 14.5 4.50002 14.5C3.70436 14.5 2.9413 14.184 2.37869 13.6213C1.81607 13.0587 1.5 12.2957 1.5 11.5C1.5 10.7044 1.81607 9.9413 2.37869 9.37868L3.55002 8.20735M12.45 7.79268L13.6213 6.62135C14.184 6.05874 14.5 5.29567 14.5 4.50002C14.5 3.70436 14.184 2.9413 13.6213 2.37869C13.0587 1.81607 12.2957 1.5 11.5 1.5C10.7044 1.5 9.9413 1.81607 9.37868 2.37869L6.37868 5.37868C6.03911 5.71802 5.78593 6.13389 5.64041 6.59137C5.49488 7.04884 5.46127 7.53456 5.5424 8.00772C5.62352 8.48087 5.81701 8.92765 6.10661 9.31053C6.39621 9.6934 6.77347 10.0012 7.20669 10.208" stroke="#0D61BF" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
                                        </g>
                                        <defs>
