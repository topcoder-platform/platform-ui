 ...
 */
 ...
 import { processSRM } from '@earn/utils/tc';
 import { getService } from '@earn/services/challenges';
 import { getReviewOpportunitiesService } from '@earn/services/reviewOpportunities';
 import { BUCKETS } from '@earn/utils/challenge-listing/buckets';
 import SORT from '@earn/utils/challenge-listing/sort';
 import { fireErrorMessage } from "@earn/utils/errors";
...
function getChallengeTypesInit() {}
/**
...
export default createActions({
  CHALLENGE_LISTING: {
    ...
    GET_CHALLENGE_TYPES_INIT: getChallengeTypesInit,
