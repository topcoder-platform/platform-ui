...
import { getService as getCommunitiesService } from '@earn/services/communities';
import * as groups from '@earn/services/lib/groups';

const getGroupService = groups.getService;
