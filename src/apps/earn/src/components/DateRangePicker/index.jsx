...
function DateRangePicker(props) {
  ...
  return (
    <div className={styled(className, "dateRangePicker")}>
      <div className={styled("dateInputWrapper")}>
        <DateInput
          id={id}
      ...
      <div ref={calendarRef} className={styled("calendar-container")}>
        {isComponentVisible && (
          <div className={styled("calendar-inner-container")}>
            ...
            />
            <div className={styled("calendar-footer")}>
              <button
                type="button"
                className={styled("calendar-button")}
                onClick={onReset}
              >
                Reset
              </button>
