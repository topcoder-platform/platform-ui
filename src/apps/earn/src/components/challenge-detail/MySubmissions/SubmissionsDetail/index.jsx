  ...
  render() {
    ...
    return (
      <div className={styled("wrapper")}>
        <div className={styled("table-header table-row")}>
          <button onClick={onCancel} type="button" className={styled("btn-back")}>
            <ArrowDown className={styled("back-icon")} />
            <span> My Submissions</span>
          </button>
          <div className={styled("table-title")}>
            <span>Submission Details: </span>
            <span className={styled("title-detail")}>
              {submission.id} ({submission.submissionId})
            </span>
          </div>
        </div>
        <div className={styled("table-tabs table-row")}>
          <div className={styled("tab-item tab-item-selected")}>
            <span>Review Summary</span>
          </div>
          <div className={styled("tab-item")}>
            <span>Artifacts</span>
          </div>
        </div>
        ...
        {sortedSubmissions.map((review) => {
          ...
          return (
            <div key={review.id} className={styled("table-row")}>
              <div
                className={styled("table-column column-1", {
                  "is-highlight": field === "Review Type",
                })}
        ...
        <div className={styled("table-row table-content-footer")}>
          ...
          <div className={styled("table-column")} />
          <div className={styled("table-column")}>
