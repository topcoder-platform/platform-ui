...
import { ReactComponent as DownloadIcon } from "../../../../assets/images/IconSquareDownload.svg";
  ...
  render() {
    ...
    return (
      <div className={styled("wrapper")}>
        <article>
          <h2 className={styled("h2")}>My Submissions</h2>
        </article>
        <div className={styled("submission-table")}>
          <div className={styled("submission-table-header submission-table-row")}>
            ...
            <div className={styled("submission-table-column column-2 score-title")}>
              <span>Score</span>
            </div>
          </div>
          <div className={styled("submission-table-header submission-table-row")}>
            <div className={styled("submission-table-column column-1")}>
              <div
                className={styled("submission-table-column column-1-1", {
              ...
              <div
                className={styled("submission-table-column column-1-2", {
            ...
            <div className={styled("submission-table-column column-2")}>
              <div
                className={styled("submission-table-column column-2-1", {
              ...
              <div
                className={styled("submission-table-column column-2-2", {
              ...
              <div
                className={styled("submission-table-column column-2-3", {
          ...
          {sortedSubmissions.map((mySubmission) => {
            ...
            return (
              <div
                ...
                className={styled("submission-table-row")}
              >
                <div className={styled("submission-table-column column-1")}>
                  <button
                    onClick={() => {
                ...
                <div className={styled("submission-table-column column-2")}>
                  ...
                  <div className={styled("submission-table-column column-2-4")}>
                    <button
                      ...
                      type="button"
                    >
                      <DownloadIcon className={styled("icon-download")} />
                    </button>
                  </div>
                </div>
              </div>
