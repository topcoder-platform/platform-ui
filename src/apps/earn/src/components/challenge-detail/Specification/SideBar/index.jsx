...
import Tooltip from "../../../Tooltip-challenge-detail";
...
export default function SideBar({
  ...
  return (
    <div className={styled("challenge-spec-sidebar")}>
      <div className={styled("challenge-sidebar-inner")}>
        ...
        {isDesign && (
          <div>
            ...
            <h2>SOURCE FILES:</h2>
            {fileTypes && (
              <ul className={styled("source-files-list")}>
        ...
        {terms.length > 0 && (
          <div>
            ...
            <div className={styled("link-like-paragraph")}>
              {terms.map((t) => (
                <div className={styled("term")} key={t.id}>
                  <a
        ...
        {legacyId && (
          <div className={styled("legacy-challenge-id")}>
            <h3>ID: {legacyId}</h3>
          </div>
        )}
      </div>
