...
import { DangerButton } from "../../UiKit";
...
import ToolbarConnector from "../../Editor/Connector";
...
export default function ChallengeDetailsView(props) {
  ...
  return (
    <div className={styled("container")}>
      ...
      <div className={styled("challenge-details-view")}>
        <div className={styled("challenge-specifications")}>
