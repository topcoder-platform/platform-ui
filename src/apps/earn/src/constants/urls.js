...
export const FACEBOOK_URL = "https://www.facebook.com/sharer/sharer.php?src=share_button&u=";
...
export const TOPCODER_PRIVACY_POLICY_URL = "http://www.topcoder.com/policy/privacy-policy";
