...
const ChallengeFilter = ({
  ...
  return (
    <div className={styled("filter")}>
      <div className={styled("buckets vertical-list")} ref={ref}>
        <RadioButton
      ...
      <div className={styled("challenge-types")}>
        <h3>Challenge Type</h3>
        <div className={styled("vertical-list")}>
      ...
      <div className={styled("total-prizes")}>
        <h3>Prize Amount</h3>
        <div className={styled("input-group")}>
          ...
          />
          <span className={styled("suffix")}>USD</span>
        </div>
        <span className={styled("separator")} />
        <div className={styled("input-group")}>
          <TextInput
            size="xs"
            label="To"
      ...
      {challengeSubCommunities.length > 0 && (
        <div className={styled("sub-communities")}>
          <h3>Sub Community</h3>
          <div className={styled("vertical-list")}>
      ...
      {/* bucket === BUCKET_OPEN_FOR_REGISTRATION && (
        <div className={styled("recommended-challenges")}>
          <span className={styled("toggle")}>
            <Toggle
              checked={recommended}
              onChange={(checked) => {
                updateFilter({
