 ...
 */
 ...
 import { combineReducers, resolveReducers } from '../../utils/redux';
 ...
 function create(initialState) {
   ...
   return handleActions({
     [a.dropChallenges + "_SUCCESS"]: state => ({
       ...state,
     ...
     [a.dropActiveChallenges + "_SUCCESS"]: state => ({
       ...state,
       challenges: [],
       lastRequestedPageOfActiveChallenges: -1,
       loadingActiveChallengesUUID: '',
     }),
     [a.dropOpenForRegistrationChallenges + "_SUCCESS"]: state => ({
       ...state,
       openForRegistrationChallenges: [],
       lastRequestedPageOfOpenForRegistrationChallenges: -1,
       loadingOpenForRegistrationChallengesUUID: '',
     }),
     [a.dropMyChallenges + "_SUCCESS"]: state => ({
       ...state,
       myChallenges: [],
       lastRequestedPageOfMyChallenges: -1,
       loadingMyChallengesUUID: '',
     }),
     [a.dropMyPastChallenges + "_SUCCESS"]: state => ({
       ...state,
       myPastChallenges: [],
       lastRequestedPageOfMyPastChallenges: -1,
       loadingMyPastChallengesUUID: '',
     }),
     [a.dropAllChallenges + "_SUCCESS"]: state => ({
       ...state,
       allChallenges: [],
       lastRequestedPageOfAllChallenges: -1,
       loadingAllChallengesUUID: '',
     }),
     [a.dropRecommendedChallenges + "_SUCCESS"]: state => ({
       ...state,
       lastRequestedPageOfRecommendedChallenges: -1,
       loadingAllChallengesUUID: '',
     }),
     [a.dropPastChallenges + "_SUCCESS"]: state => ({
       ...state,
       pastChallenges: [],
       lastRequestedPageOfPastChallenges: -1,
       loadingPastChallengesUUID: '',
     }),
     [a.expandTag + "_SUCCESS"]: (state, { payload }) => ({
       ...state,
     ...
     [actionChallenge.registerDone + "_SUCCESS"]: onRegisterDone,
     [actionChallenge.unregisterDone + "_SUCCESS"]: onUnregisterDone,
 
     [a.getActiveChallengesInit + "_SUCCESS"]: onGetActiveChallengesInit,
     [a.getActiveChallengesDone + "_SUCCESS"]: onGetActiveChallengesDone,
 
     [a.getOpenForRegistrationChallengesInit + "_SUCCESS"]: onGetOpenForRegistrationChallengesInit,
     [a.getOpenForRegistrationChallengesDone + "_SUCCESS"]: onGetOpenForRegistrationChallengesDone,
 
     [a.getMyChallengesInit + "_SUCCESS"]: onGetMyChallengesInit,
     [a.getMyChallengesDone + "_SUCCESS"]: onGetMyChallengesDone,
 
     [a.getMyPastChallengesInit + "_SUCCESS"]: onGetMyPastChallengesInit,
     [a.getMyPastChallengesDone + "_SUCCESS"]: onGetMyPastChallengesDone,
 
     [a.getAllChallengesInit + "_SUCCESS"]: onGetAllChallengesInit,
     [a.getAllChallengesDone + "_SUCCESS"]: onGetAllChallengesDone,
 
     [a.getTotalChallengesCountInit + "_SUCCESS"]: onGetTotalChallengesCountInit,
     [a.getTotalChallengesCountDone + "_SUCCESS"]: onGetTotalChallengesCountDone,
 
     // [a.getRestActiveChallengesInit]: onGetRestActiveChallengesInit,
     // [a.getRestActiveChallengesDone]: onGetRestActiveChallengesDone,
 
     [a.getChallengeTypesInit + "_SUCCESS"]: state => ({
       ...state,
       loadingChallengetypes: true,
     }),
     [a.getChallengeTypesDone + "_SUCCESS"]: onGetChallengeTypesDone,
 
     [a.getChallengeTagsInit + "_SUCCESS"]: state => ({
       ...state,
       loadingChallengeTags: true,
     }),
     [a.getChallengeTagsDone + "_SUCCESS"]: onGetChallengeTagsDone,
 
     [a.getPastChallengesInit + "_SUCCESS"]: onGetPastChallengesInit,
     [a.getPastChallengesDone + "_SUCCESS"]: onGetPastChallengesDone,
 
     [a.getReviewOpportunitiesInit + "_SUCCESS"]: onGetReviewOpportunitiesInit,
     [a.getReviewOpportunitiesDone + "_SUCCESS"]: onGetReviewOpportunitiesDone,
 
     [a.getSrmsInit + "_SUCCESS"]: onGetSrmsInit,
     [a.getSrmsDone + "_SUCCESS"]: onGetSrmsDone,
 
     // [a.getUserChallengesInit]: onGetUserChallengesInit,
     // [a.getUserChallengesDone]: onGetUserChallengesDone,
 
     [a.selectCommunity + "_SUCCESS"]: onSelectCommunity,
 
     [a.setFilter + "_SUCCESS"]: onSetFilter,
     [a.setSort + "_SUCCESS"]: (state, { payload }) => ({
       ...state,
       sorts: {
         ...state.sorts,
 ...
 export function factory(req) {
   if (req && req.url.match(/challenges(\/?$|\/?\?)/)) {
     ...
     }).then(reducers => combineReducers(create(state), { ...reducers, filterPanel }));
   }
 
   return resolveReducers({
     sidebar: sidebarFactory(req),
   }).then(reducers => combineReducers(create(), { ...reducers, filterPanel }));
 }
