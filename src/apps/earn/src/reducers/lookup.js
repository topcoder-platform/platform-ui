 ...
 * @return {Object} New state
 */
function onGetAllCountriesDone(state, { payload: countries, error }) {
  if (error) {
    logger.error("Failed to get all countries", countries);
    return { ...state, countriesError: true };
  }
...
function create(initialState = {}) {
  ...
  return handleActions(
    {
      [`${a.getTagsDone}_SUCCESS`]: onGetTagsDone,
      [a.getCommunityListInit]: onGetCommunityListInit,
      [`${a.getCommunityListDone}_SUCCESS`]: onGetCommunityListDone,
      [`${a.onGetCommunityListDone}_SUCCESS`]: onGetCommunityListDone,
      [a.getTypesInit]: (state) => state,
      [`${a.getTypesDone}_SUCCESS`]: onGetTypesDone,
      [a.getManufacturersInit]: onGetManufacturersInit,
      [`${a.getManufacturersDone}_SUCCESS`]: onGetManufacturersDone,
      [a.getModelsInit]: onGetModelsInit,
      [`${a.getModelsDone}_SUCCESS`]: onGetModelsDone,
      [a.getOsesInit]: onGetOsesInit,
      [`${a.getOsesDone}_SUCCESS`]: onGetOsesDone,
      [a.getSkillTagsInit]: (state) => state,
      [`${a.getSkillTagsDone}_SUCCESS`]: onGetSkillTagsDone,
      [a.getCountriesInit]: (state) => state,
      [`${a.getCountriesDone}_SUCCESS`]: onGetCountriesDone,
      [a.getReviewTypesInit]: (state) => state,
      [`${a.getReviewTypesDone}_SUCCESS`]: onGetReviewTypesDone,
      [a.getAllCountriesInit]: onGetAllCountriesInit,
      [`${a.getAllCountries}_SUCCESS`]: onGetAllCountriesDone,
    },
