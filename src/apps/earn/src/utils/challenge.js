...
/**
 * Convert the query of `/earn/challenges` path into the challenge filter.
 *
...
/**
 * Define the validation scheme for `/earn/challenges` url query
 *
 * The scheme is used when the app is mounted with `/earn/challenges` request.
 */
