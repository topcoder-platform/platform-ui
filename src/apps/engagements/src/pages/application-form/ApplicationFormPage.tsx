...
import { ApplicationFormData, PrePopulatedUserData } from './application-form.types'
...
const ApplicationFormPage: FC = () => {
    ...
    const [userData, setUserData] = useState<PrePopulatedUserData | null>(null)
    ...
    return (
        ...
        >
            ...
            {!isLoading && !error && !engagement && (
                <div className={styles.errorState}>
                    <IconOutline.ExclamationIcon className={styles.errorIcon} />
                    <div>
                        <p className={styles.errorText}>Engagement not available.</p>
                        <Button label='Back to Engagements' onClick={handleBackToEngagement} secondary />
                    </div>
                </div>
            )}

            {!isLoading && !error && engagement && applicationError && (
                <div className={styles.errorState}>
                    <IconOutline.ExclamationIcon className={styles.errorIcon} />
                    <div>
            ...
            {!isLoading && !error && engagement && hasApplied && !applicationError && (
            ...
            {!isLoading && !error && engagement && !hasApplied && !applicationError && (
                <div className={styles.formContainer}>
                    ...
                    {!engagementClosed && deadlinePassed && (
                    ...
                    <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <section className={styles.section}>
                            ...
                            <div className={styles.fieldGroup}>
                                <label className={styles.fieldLabel} htmlFor='years-of-experience'>Years of Experience</label>
                                <Controller
                                    ...
                                    render={({ field }) => (
                                        <input
                                            ...
                                            aria-describedby={errors.yearsOfExperience ? 'years-of-experience-error' : undefined}
                                        />
                                    )}
                                />
