...
const DEFAULT_MEMBER_AVATAR = 'https://d1aahxkjiobka8.cloudfront.net/static-assets/images/ab4a084a9815ebb1cf8f7b451ce4c88f.svg'
...
const ProfilePageJumbo: FC<ProfilePageJumboProps> = (props: ProfilePageJumboProps) => {
    const { profile } = props
    const photoURL = profile?.photoURL || DEFAULT_MEMBER_AVATAR
