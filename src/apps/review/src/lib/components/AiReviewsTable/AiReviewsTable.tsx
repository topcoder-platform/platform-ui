...
const AiReviewsTable: FC<AiReviewsTableProps> = props => {
    ...
    const lockMessage = useMemo(() => {
        ...
        const failedReviewersText = failedGatingReviewers.length
            ? `Gating Reviewers failed: ${failedGatingReviewers.join(', ')}. This submission is automatically failed regardless of Overall Score.`
            : `This submission is failed because ${hasSubmitterRole ? 'your' : 'the'} Overall Score is bellow minimum threshold.`
