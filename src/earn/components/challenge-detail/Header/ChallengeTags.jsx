...
import {
  Tag,
  DevelopmentTrackTag,
} from '@earn/components/challenge-detail/tags';

import { COMPETITION_TRACKS } from '@earn/utils/tc';
import VerifiedTag from '@earn/components/challenge-detail/VerifiedTag';
import MatchScore from '@earn/components/challenge-detail/ChallengeCard/MatchScore';
import { calculateScore } from '@earn/utils/challenge-listing/helper';
import './style.scss';
