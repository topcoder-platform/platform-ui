  ...
  return handleActions(
    {
      ...
      [`${a.getBasicDetails}_SUCCESS`]: onGetBasicDetailsDone,
      [a.getFullDetailsInit]: onGetFullDetailsInit,
      [`${a.getFullDetails}_SUCCESS`]: onGetFullDetailsDone,
      [a.getSubmissionsInit]: onGetSubmissionsInit,
      [`${a.getSubmissions}_SUCCESS`]: onGetSubmissionsDone,
      [`${a.getMmSubmissionsInit}`]: onGetMMSubmissionsInit,
      [`${a.getMmSubmissions}_SUCCESS`]: onGetMMSubmissionsDone,
      [`${smpActions.smp.deleteSubmissionDone}_SUCCESS`]: (state, { payload }) => ({
        ...state,
        mySubmissions: {
          ...state.mySubmissions,
      ...
      [`${a.register}_SUCCESS`]: onRegisterDone,
      [a.unregisterInit]: (state) => ({ ...state, unregistering: true }),
      [`${a.unregister}_SUCCESS`]: onUnregisterDone,
      [`${a.loadResultsInit}`]: onLoadResultsInit,
      [`${a.loadResults}_SUCCESS`]: onLoadResultsDone,
      [`${a.fetchCheckpointsInit}`]: (state) => ({
        ...state,
        checkpoints: null,
        loadingCheckpoints: true,
      }),
      [`${a.fetchCheckpoints}_SUCCESS`]: onFetchCheckpointsDone,
      [a.updateChallengeInit]: onUpdateChallengeInit,
      [`${a.updateChallenge}_SUCCESS`]: onUpdateChallengeDone,
      [a.getActiveChallengesCountInit]: (state) => state,
      [`${a.getActiveChallengesCount}_SUCCESS`]: onGetActiveChallengesCountDone,
      [a.getSubmissionInformationInit]: onGetSubmissionInformationInit,
      [`${a.getSubmissionInformation}_SUCCESS`]: onGetSubmissionInformationDone,
